                                                ...
                                                <div class="book-card">
                                                    ...
                                                    <?php if ($result['UserID'] == $user_id) : ?>
                                                        <div class="button-container">
                                                            <a href="read_online.php?bookId=<?php echo $result['bookid']; ?>" target="_blank"><button class="btn btn-primary"><i class="fas fa-eye"></i>Read Online</button></a>
                                                            <a href="download_pdf.php?bookId=<?php echo $result['bookid']; ?>" target="_blank"><button class="btn btn-success"><i class="fas fa-file-pdf"></i>Download PDF</button></a>
                                                        </div>
                                                    <?php else : ?>
                                                        <div class="button-container">
