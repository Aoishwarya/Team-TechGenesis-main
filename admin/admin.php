...
<head>
    ...
    <style>
        ...
        /* Navbar style */
        .navbar {
            background-color: #a885e8; /* Dark purple navbar background */
        }

        .navbar-brand img {
            max-height: 40px; /* Limit logo height in navbar */
        }

        .navbar-light .navbar-nav .nav-link {
            color: #A9A9A9; /* black color for navbar links */
        }
        ...
        /* Card styles */
        .card {
            border: 1px solid #d6b5ff; /* Light purple border for cards */
            margin-bottom: 20px;
        }
        ...
        .card-title {
            font-size: 20px;
            color: #7a3dab; /* Darker purple color for card titles */
            margin-bottom: 10px;
        }
        ...
        .card-text {
            font-size: 24px;
            font-weight: bold;
            color: #7a3dab; /* Darker purple color for card text */
        }

        /* Additional styles */
        h2 {
            color: #7a3dab; /* Darker purple color for headings */
        }

        a {
            color: #7a3dab; /* Darker purple color for links */
        }
    </style>
