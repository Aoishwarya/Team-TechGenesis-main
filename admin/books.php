...
<head>
   ...
   /* Navbar Background and Text Color */
        ...
        .table-striped tbody tr:hover {
            background-color: #ede7f6; /* Light Purple Hover Background */
        }
        ...
        .paginate_button {
            background-color: #d1c4e9; /* Light Purple Background */
            color: #4527a0; /* Dark Purple Text Color */
            border-color: #4527a0; /* Dark Purple Border Color */
        }
        .paginate_button.current {
            background-color: #4527a0; /* Dark Purple Background for Active Button */
            color: #fff; /* White Text Color for Active Button */
        }
        .paginate_button:hover {
            background-color: #4527a0; /* Dark Purple Background on Hover */
