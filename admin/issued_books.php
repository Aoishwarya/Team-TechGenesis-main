...
<body>
 ...
 <style>
        ...
        /* Page Header Styling */
        .header-line {
            color: #7b1fa2; /* Purple header text color */
            border-bottom: 2px solid #7b1fa2; /* Purple header underline */
            padding-bottom: 10px; /* Optional: Adjust padding */
            margin-bottom: 20px; /* Optional: Adjust margin */
        }

        /* Alert Messages Styling */
        .alert {
            border-color: #7b1fa2; /* Purple alert border color */
        }

        .alert-danger {
            background-color: #f8d7da; /* Light red alert background */
            border-color: #f5c6cb; /* Red alert border color */
            color: #721c24; /* Dark red alert text color */
        }

        .alert-success {
            background-color: #d4edda; /* Light green alert background */
            border-color: #c3e6cb; /* Green alert border color */
            color: #155724; /* Dark green alert text color */
        }
        ...
        th {
            background-color: #cc99ef; /* Purple table heading background */
            color: #ffffff; /* White table heading text color */
        }
